            ...
            <aside className={cn(
                ...
                <div className="flex-1 overflow-y-auto">
                    <div className="relative">
                        <SidebarContent navItems={navItems} pathname={pathname} onNavigate={() => setIsMobileMenuOpen(false)} />
...
function SidebarContent({ navItems, pathname, onNavigate }: { navItems: any[], pathname: string, onNavigate?: () => void }) {
    return (
        <>
